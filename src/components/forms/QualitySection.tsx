  ...
  return (
    <div className="glass-panel border-white/5 space-y-6 p-6 md:p-8">
      <div className="flex items-center gap-3 border-b border-white/5 pb-4 mb-6">
        <div className="w-8 h-8 rounded bg-primary/10 flex items-center justify-center text-primary font-bold shadow-[0_0_10px_rgba(99,102,241,0.2)]">4</div>
        <h3 className="text-lg font-bold tracking-widest text-foreground uppercase">QUALITY PARAMETERS</h3>
      </div>
